...
### 2. 垂直激发态（Vertical Excited State）
...
### 3. 绝热激发态（Adiabatic Excited State）
...
### 15. 单分子反应（Single-Molecule Reaction）
...
### 16. 芳香性计算（Aromaticity Calculations）
...
#### &emsp;16.2 磁感应电流模拟（Anisotropy of the Induced Current Density，AICD）
